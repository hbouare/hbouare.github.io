...
Call log:
  ...
  - waiting for locator('.v-application')
    42 × locator resolved to <div class="v-application v-theme--dark v-layout v-layout--full-height v-locale--is-ltr">…</div>
...
- main:
  ...
  - text: Python Vue.js Typescript OpenShift Airflow Redis Gitlab CD/CD PostgreSQL Playwright April 2024 — February 2026
  ...
  - text: Nuxt.js Typescript Aws Mongodb Github Actions Terraform January 2023 — January 2024
  ...
  - text: TypeScript Python Imaging Framework Playwright Docker Jenkins SinonJs Rally June 2022 — December 2022
  - heading "Full-Stack Developer" [level=3]
  - paragraph: BHP
  - text: 🇫🇷 Paris, France
  ...
  - text: Nodes.js Vue.js Mongodb Postgresql Gitlab CD/CD Docker Jira September 2021 — June 2022
  ...
  - text: Python Postgresql Matlab Angular Gitlab CI/CD Docker Jira April 2018 — September 2021
